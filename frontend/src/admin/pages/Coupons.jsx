...
function Coupons() {
  ...
  const handleDelete = (couponCode) => {
    fetch(`http://localhost:3000/system/coupons/${couponCode}`, {
      ...
      .then((response) => {
        ...
        const updatedConpons = coupons.filter(
  ...
  const handleCouponCodeCheck = async () => {
    try {
      const response = await fetch(
        `http://localhost:3000/system/check-coupon-code?coupon_code=${newCoupon.couponCode}`
      );
  ...
  const handleCouponCodeChange = (e) => {
    ...
    setNewCoupon({ ...newCoupon, couponCode: value });
    if (name === "couponCode") {
      setCouponCodeExists(false);
    }
  };
  const handleDiscountAmountChange = (e) => {
    ...
    setNewCoupon({ ...newCoupon, discountAmount: value });
  };
  ...
  const handleDateChange = (date) => {
    setNewCoupon({ ...newCoupon, expirationDate: date });
  };
  /*************************************************************************************************/
                      ...
                      {filteredCoupons
                        ...
                        .map((coupon) => (
                          <tr key={coupon.coupon_code}>
                            ...
                            <td className="text-cell">
                              <button
                                onClick={() => handleDelete(coupon.coupon_code)}
          ...
          <div className="modal">
            <div className="modal-content">
              ...
              <Form onSubmit={handleAddCoupon}>
                <Form.Group className="form-layout" controlId="couponCode">
                  <Form.Control
                    type="text"
                ...
                <Form.Group className="form-layout" controlId="discountAmount">
                  <Form.Control
                    type="number"
                ...
                <Form.Group className="form-layout" controlId="discountType">
                  ...
                  <div>
                    <Form.Check
                      ...
                      name="discountType"
                      value="Fixed Amount"
                      checked={newCoupon.discountType === "Fixed Amount"}
                ...
                <Form.Group className="form-layout" controlId="expirationDate">
