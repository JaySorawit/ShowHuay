 ...
 *   ShopProfile.jsx                                                *
 *                                                                  *
 *   This page is displaying detailed information about a           *
 *   shop and seller. It often includes shop details, reviews,      *
 *   and a selection of products from the specific shop.            *
 *                                                                  *
 ********************************************************************/
              ...
              <Row>
                ...
                <Col md={8}>
                  <div className="box-seller-info">
                    ...
                    <h5 className="tel-seller">
                      <i
                        className="nav-icon fas fa-phone"
                        style={{
                          fontSize: "14px",
                          marginRight: "7px",
                    ...
                    {sellerInfo.userId != userId && (
                      <button
                        ...
                        onClick={() => handleChat(sellerInfo.userId)}
                      >
                        Chat
                      </button>
                    )}
