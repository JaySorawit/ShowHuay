...
const Footer = () => {
  return (
    <footer className="footer mt-auto" style={{ backgroundColor: '#D9D9D9', height: '200px' }}>
      <div className="container d-flex flex-column justify-content-between align-items-center h-100">
        ...
        <div style={{ marginTop: '34px', marginBottom: '64px'}}>
          <img src={logo1} alt="Logo 1" className="logo-img" style={{ marginRight: '27px'}} />
          <img src={logo2} alt="Logo 2" className="logo-img" style={{ marginRight: '27px'}} />
          <img src={logo3} alt="Logo 3" className="logo-img" style={{ marginRight: '27px'}} />
