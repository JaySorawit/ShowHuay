 ...
 *   MyProfile.jsx                                                  *
 *                                                                  *
 *   This page is displaying and allowing users to edit their       *
 *   personal profile information. It typically includes details    *
 *   such as name, email, and other user-specific data.             *
 *                                                                  *
 ********************************************************************/
    ...
    const getUserData = async () => {
      try {
        const res = await axios.get(
          `http://localhost:3000/account/getuser/${userId}`
        );
          ...
          <Row>
            ...
            <Col md={10}>
              <div className="infoBox">
                ...
                {user ? (
                  <div className="userInfo">
                    <div className="info">
                      ...
                      <p>
                        <b>Phone :</b> {user.telephoneNumber || "-"}
                      </p>
                      <p>
                ...
                <Link to="/editMyProfile" style={{ margin: "0 auto" }}>
